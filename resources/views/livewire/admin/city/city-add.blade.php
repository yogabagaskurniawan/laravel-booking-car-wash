<div>
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/cities/list-cities">Kota</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Kota</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form class="" wire:submit="addCity">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="fullName">Nama Kota</label>
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Tambah Kota</button>
                </form>
