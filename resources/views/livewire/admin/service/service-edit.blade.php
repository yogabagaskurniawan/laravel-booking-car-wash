    ...
    <div class="col-lg-12 layout-spacing layout-top-spacing">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form class="" wire:submit="editService">
                    <div class="row mb-4">
                        <div class="col-sm-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <div wire:ignore class="col-md mt-3">
                                ...
                                @if ($service->image)
                                    <img src="/assets/service/{{ $service->image }}" class="img-preview img-fluid mb-3 col-sm-5 d-block imageDemo1">   
                                @endif
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Edit Layanan</button>
                </form>
            </div>
        </div>
    </div>
